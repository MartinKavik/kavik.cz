---
title: "MoonZoon: Foundations (2021)"
description: "Signals over hooks, WASM size battles, and fullstack Rust lessons from building MoonZoon."
sortOrder: 3
...
Development continued for another 4.5 years after these articles. Routing, animations, Web Workers, Tauri desktop apps, and GPU graphics with wgpu all followed. Read [MoonZoon: 2021–2025](/blog/moonzoon-2021-2025) for the full story.

Many ideas from MoonZoon eventually carried forward into [Boon](/#boon). The reactive signals architecture evolved into Boon's dataflow model. The frustration with HTML/CSS abstraction led to new rendering approaches. For the ideas that shaped it, read [The Boon of Dataflow](/blog/the-boon-of-dataflow).
